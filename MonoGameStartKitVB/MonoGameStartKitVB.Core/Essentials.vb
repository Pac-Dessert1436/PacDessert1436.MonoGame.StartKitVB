...
#End Region
    ...
    ' NOTE: Scheduling methods for the following events are auto-generated by
    '       `ModuleEventRaiser.Generator` v1.2.2. This source generator automatically 
    '       creates thread-safe `RaiseEvent` methods for all declared events.
