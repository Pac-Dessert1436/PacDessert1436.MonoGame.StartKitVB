...
#End Region
    ...
    ' NOTE: The scheduling methods for the following events are generated by
    '       `ModuleEventRaiser.Generator` v1.2.5.1. This source generator creates
    '       `RaiseEvent` helpers for the declared events in this module, but the
    '       project uses the scheduling methods.
