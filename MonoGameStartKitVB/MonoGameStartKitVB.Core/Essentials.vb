...
#End Region
    ...
    ' NOTE: The scheduling helpers for the following events are generated by
    '       ModuleEventRaiser.Generator v1.2.5.1. The generator creates RaiseEvent
    '       helpers for the declared events in this module, while the project uses
    '       the scheduling methods built on top of them.
...
#Region "Functions and Properties"
    ...
    ''' </summary>
    ''' <remarks>
    ''' When you add new buttons, remember to update <see cref="GameManager.HandleInput"/> as well.
    ''' </remarks>
    ...
    ''' <summary>
    ''' Saves the high score to a JSON file. Any exception caught during this process
    ''' will be logged via <see cref="Trace.TraceError"/>.
    ''' </summary>
    ...
    Public Sub SaveHighScore(highScore As Integer)
        ...
        Catch ex As Exception
            Trace.TraceError($"Failed to save high score: {ex.Message}")
        End Try
    End Sub

    ''' <summary>
    ''' Loads the high score from a JSON file. Any exception caught during this process
    ''' will be logged via <see cref="Trace.TraceError"/>.
    ''' </summary>
    ...
    Public Function LoadHighScore() As Integer
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Trace.TraceError($"Failed to load high score: {ex.Message}")
        End Try
        Return 0
    End Function
#End Region
